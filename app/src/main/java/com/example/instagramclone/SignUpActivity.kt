...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(fullName: String, userName: String, email: String, progressDialog: ProgressDialog) {
        ...
        userMap["image"] =
            "https://firebasestorage.googleapis.com/v0/b/my-instagram-app-bfb99.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=98a80d0d-6ced-468f-beaa-201ede175211"
