...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        change_image_text_btn.setOnClickListener {
            ...
            CropImage.activity() //send user to gallery of mobile
                .setAspectRatio(1,1)
    ...
    private fun userInfo()//updating the user information in accountsettingsactivity
    {
    ...
    private fun updateUserInfoOnly() { //update only user info
        // we can use both TextUtils or simple way to check if it is Empty or not
        when {
